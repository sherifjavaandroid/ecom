        ...
        child: Scaffold(
          ...
          body: SafeArea(
            ...
            SliverToBoxAdapter(
                child: Center(
              child: SizedBox(
                width: ResponsiveHelper.isDesktop(context) ? 400 : null,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomTextFieldWidget(
                                  hintText:
                                      getTranslated('6+character', context),
                                ...
                                CustomButtonWidget(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (userInput.isEmpty) {
                                      ...
                                      bool isNumber =
                                          PhoneNumberCheckerHelper.isValidPhone(
                                              userInput);
                                      if (isNumber) {
                                        userInput =
                                      ...
                                      await authProvider
                                          .login(context, userInput, password,
                                              type,
                                        ...
                                        if (status.isSuccess) {
                                          if (authProvider.isActiveRememberMe) {
                                            authProvider
                                              ...
                                              phoneNumber:
                                                  isNumber ? userInput : null,
                                              email:
                                                  isNumber ? null : userInput,
                                              password: password,
            ...
            const SliverFillRemaining(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //       100.0), // Adjust padding as necessary
                  //   child: Align(
                  ...
                  //         color: Theme.of(context)
                  //             .hintColor, // Use a color that matches the theme
                  //       ),
                  //     ),
                  //   ),
                  // ),
